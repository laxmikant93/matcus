...
app.get('/sitemap.xml', async (req, res) => {
  ...
  let productsData = await axios.get(`https://middleware.unicated.com/authorization-middleware/getDynamicSeo/?domain=${subdomain}`);
...
//   const filePath = path.resolve(__dirname, "/var/www/wahuz/wahuz", "robots.txt");
...
app.get("/", async (req, res) => {
  ...
  let businessData = await axios.get(`https://middleware.unicated.com/authorization-middleware/getDynamicSeo/?domain=${subdomain}`);
  seoData = businessData.data.data
  //const filePath = path.resolve(__dirname, "/var/www/html/", "index.html");
  const filePath = path.resolve(__dirname, "/var/www/wahuz/wahuz", "index.html");
...
app.get("/products/:id", async (req, res) => {
  ...
  let productsData = await axios.get(`https://middleware.unicated.com/authorization-middleware/getDynamicProductSlugSeo/?domain=${subdomain}&slug=${req.params.id}`);
  seoData = productsData.data.data
...
app.get("/blog/:id", async (req, res) => {
  ...
  let productsData = await axios.get(`https://middleware.unicated.com/authorization-middleware/getDynamicBlogSlugSeo/?domain=${subdomain}&slug=${req.params.id}`);
  seoData = productsData.data.data
...
app.use(express.static(path.resolve(__dirname, "/var/www/wahuz/wahuz")))
