...
const Miscellaneous = ({ updateOnHeader, updateOnFooter, data }) => {
  ...
  useEffect(() => {
    if (data) {
      let checkedItem = data.find((item) => item.path === "/miscellaneous")
    ...
    <>
      ...
      <hr className='hr-line' />
        <li className="checkbox-group">
          ...
          <CheckboxInput label="Show this page on Header" checked={checked.showOnFooter} onChange={(e) => showOnMenuList(e, 'footer')} />
        </li>
      </ul>
    </>
  )
