...
const MessageDeskItem = styled.div`
display: grid;
...
h4{
  font-weight: ${({ theme }) => theme.AboutUsPage.h4.FontWeight};
  font-size: ${({ theme }) => theme.AboutUsPage.h4.FontSize};
  line-height: ${({ theme }) => theme.AboutUsPage.h4.LineHeight};
  font-style: ${({ theme }) => theme.AboutUsPage.h4.FontStyle};
  font-family: ${({ theme }) => theme.AboutUsPage.h4.FontFamily};
  letter-spacing: ${({ theme }) => theme.AboutUsPage.h4.LetterSpacing};
  color: ${({ theme }) => theme.AboutUsPage.h4.Color};
  }
  h5{
  font-weight: ${({ theme }) => theme.AboutUsPage.h5.FontWeight};
  font-size: ${({ theme }) => theme.AboutUsPage.h5.FontSize};
  line-height: ${({ theme }) => theme.AboutUsPage.h5.LineHeight};
  font-style: ${({ theme }) => theme.AboutUsPage.h5.FontStyle};
  font-family: ${({ theme }) => theme.AboutUsPage.h5.FontFamily};
  letter-spacing: ${({ theme }) => theme.AboutUsPage.h5.LetterSpacing};
  color: ${({ theme }) => theme.AboutUsPage.h5.Color};
  }
  p{
  ...
  padding-top: ${({ theme }) => theme.AboutUsPage.p.PaddingTop};
  ...
  &::before{
  font-size: 12px;
  color: ${({ theme }) => theme.AboutUsPage.FounderMessage.Dots.Active.Color};
  }
  }
  }
  button{
  &::before{
  font-size: 12px;
  color: ${({ theme }) => theme.AboutUsPage.FounderMessage.Dots.Color};
  }
  }
  }
  .slick-prev{
    ...
    width: 1.3rem;
    height: 1.3rem;
    border-right: 2px solid ${({ theme }) => theme.AboutUsPage.FounderMessage.SlickArrowColor.Color};
    border-bottom: 2px solid ${({ theme }) => theme.AboutUsPage.FounderMessage.SlickArrowColor.Color};
    z-index: 0;
    margin-left: -0.5rem;
    ...
    &:hover{
      border-right: 2px solid ${({ theme }) => theme.AboutUsPage.FounderMessage.SlickArrowColor.Hover.Color};
      border-bottom: 2px solid ${({ theme }) => theme.AboutUsPage.FounderMessage.SlickArrowColor.Hover.Color};    
    }
    @media screen and (max-width: 768px) {
      width: 1rem;
      height: 1rem;
    ...
    width: 1.3rem;
    height: 1.3rem;
    border-left: 2px solid ${({ theme }) => theme.AboutUsPage.FounderMessage.SlickArrowColor.Color};
    border-bottom: 2px solid ${({ theme }) => theme.AboutUsPage.FounderMessage.SlickArrowColor.Color};
    z-index: 0;
    margin-right: -0.5rem;
    transform: rotate(-135deg);
    ...
    &:hover{
      border-left: 2px solid ${({ theme }) => theme.AboutUsPage.FounderMessage.SlickArrowColor.Hover.Color};
      border-bottom: 2px solid ${({ theme }) => theme.AboutUsPage.FounderMessage.SlickArrowColor.Hover.Color};    
    }
    @media screen and (max-width: 768px) {
      width: 1rem;
...
img{
object-fit: cover;
width: ${({ theme }) => theme.AboutUsPage.FounderMessage.MessageProfileImage.Width};
height: ${({ theme }) => theme.AboutUsPage.FounderMessage.MessageProfileImage.Height};
border-radius: ${({ theme }) => theme.AboutUsPage.FounderMessage.MessageProfileImage.BorderRadius};
@media screen and (max-width: 768px) {
  width: 100%;
  height: 100%;
}
...
export default AboutPageFounderMessage