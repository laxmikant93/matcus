...
h3{
  ...
  &::after{
  width: 100%;
  height: ${({ theme }) => theme.Contact.ContactPage.BorderBottom.BorderWidth};
  background-color: ${({ theme }) => theme.Contact.ContactPage.BorderBottom.Background};
  bottom: ${({ theme }) => theme.Contact.ContactPage.BorderBottom.BottomSpace};
  }
  }
}
`;
              ...
              <ContactContentListItem>
                ...
                <ContactListItemDetail>
                  ...
                  <ContactListItemDetailInner>
                    ...
                    <AppLink to="#" rel="noopener noreferrer">sherlockhlmes3421@gmail.com</AppLink>
                  </ContactListItemDetailInner>
                </ContactListItemDetail>
              </ContactContentListItem>
            </ContactContentList>
