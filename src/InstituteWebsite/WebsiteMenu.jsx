...
import "./WebsiteMenu.scss";
const WebsiteMenu = ({ children }) => {
  ...
  return (
    <div className="subdomainTopNav">
      <div className="nav-tab-menu-scroll">
        ...
        <div id="pnProductNav" className="pn-ProductNav">
          <div id="pnProductNavContents" className="pn-ProductNav_Contents">
            <div className="scroll-top-menu-wrap">
              {/* <ul className="sd-navbar pn-ProductNav_Link" aria-selected="true">{children}</ul> */}
              {/* <ul className="sd-navbar pn-ProductNav_Link">{children}</ul> */}
              <ul className="sd-navbar">{children}</ul>

            </div>
          </div>
        </div>

        <button id="pnAdvancerLeft"
          // className="bottomNavArrowLeft"
          className="pn-Advancer pn-Advancer_Left"
          type="button">  <i className="arrowcustom left"></i>
        ...
        <button id="pnAdvancerRight"
          className="pn-Advancer pn-Advancer_Right"
          type="button">  <i className="arrowcustom right"></i>
