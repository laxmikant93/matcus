...
const InstituteWebsiteHeroPreview = () => {
          ...
          (data.banners && data.banners.length) > 1 ? (
            ...
            <div className="institute-banner">
              {data.banners && data.banners[0].institute_featured_banner ? (
                <ImageViewer
                  object={data.banners[0].institute_featured_banner}
        ...
        <>
          <section className="institute-info-sec">
            <div className="institute-info">
              {/* <h1 className="text-sm w-500 capitalize">{data.institute_name}</h1> */}
              ...
              <p className="sd-contact-display">
                <span
                  onClick={(e) => {
                    e.preventDefault();
                    const tel = data.institute_phone;
                    window.open("tel:", { tel });
                  }}
                ...
                <span
                  onClick={(e) => {
                    e.preventDefault();
                    const email = data.institute_email;
...
export default InstituteWebsiteHeroPreview;
