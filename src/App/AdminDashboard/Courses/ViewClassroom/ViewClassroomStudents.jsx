...
const ViewClassroomStudents = () => {
  ...
  return (
    <React.Fragment>
      <div className="PageTopHead PTH-ViewClassroomStudent mt-20">
                ...
                return (
                  <div className="gridRow" key={item._id}>
                    <ul className="topInfo">
                      ...
                      <li className="col col-2" data-head="Admission No">
...
export default ViewClassroomStudents;
