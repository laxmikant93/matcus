...
const StudentFeeListing = () => {
  ...
  const {
    ...
    return {
      ...
      studentCourseDataSuccess:
        state.feeManagementStudent.studentCourseData.success,
      studentCourseLoading:
        state.feeManagementStudent.studentCourseData.loading,
  ...
  const handleClick = (item) => {
    history(
      `/dashboard/student/student-fee-listing-details/${item.course}-${item.institute}-${item.user}`
    );
  };
  return (
    <React.Fragment>
