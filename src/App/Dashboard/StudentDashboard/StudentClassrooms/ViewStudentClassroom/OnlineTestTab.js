...
const ViewClassroomOnlineTest = () => {
  ...
  useEffect(() => {
    dispatch(
      getClassroomViewList(users.user_institute, _classroomId, ToggleValue)
    );
    dispatch(getAssignmentTeacherClassroom(users.user_institute, _classroomId));
  }, [_classroomId, dispatch, users._id, users.user_institute]);
  ...
  const SingleSelectHandel = (item) => {
    ...
    switch (message) {
      ...
      case "Recent to Old":
        dispatch(
          SortOnlineTest(users.user_institute, _classroomId, "quizon", "rto")
        );
        break;
      case "Old to Recent":
        dispatch(
          SortOnlineTest(users.user_institute, _classroomId, "quizon", "otr")
        );
        break;
      case "High to Low 1":
        dispatch(
          SortOnlineTest(users.user_institute, _classroomId, "question", "htl")
        );
        break;
      case "Low to High 1":
        dispatch(
          SortOnlineTest(users.user_institute, _classroomId, "question", "lth")
        );
        break;
      case "High to Low 2":
        dispatch(
  ...
  return (
    <React.Fragment>
      <div className="PageTopHead PTH-ViewClassroomOnlineTest mt-20">
        ...
        <div className="PTH-Item">
          <button onClick={handleReload} className="refreshBtn">
