...
const FailedItem = ({ orderId }) => {
  ...
  const { getShipItemsSuccess, getShipItemsData,updateDeliverFailedSubOrderLoaded,updateDeliverFailedSubOrderSuccess,getFailItemsSuccess,getFailItemsData } = useSelector((state) => {
    return {
    ...
    <div>
      <div className="gridListTable  ">
        ...
        <div className="gridBody shipped-item-table-wrapper">
          {
            getFailItemsData && getFailItemsData.map((item) => (
                ...
                <ul className="topInfo">
                  ...
                  <li className="col col-2 text-center" data-head="TRACK" >
                    ...
                    </div>
                    {
                      ...
                      trackingId={item?.data[0]?.shipping_tracking_id} trackingUrl={item?.data[0]?.tracking_url}
                      propData={propData}
                      />
