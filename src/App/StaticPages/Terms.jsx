  ...
  return (
    <>
      <div className="edContainer">
        <div className="terms-custom mt-80">
          <h1 className="sub-heading text-sm w-600 mb-20">Terms of Service</h1>
          <p className="text-xxs">
            These Terms & Conditions <strong>(“Terms”)</strong> of (a) use of
            our website www.edneed.com <strong>(“Website”),</strong> our
            applications <strong>(“SAAS Application”)</strong> or any products
            or services in connection with the Application/, Website/products
            <strong>(“Services”)</strong> or (b) any modes of registrations or
            usage of products, including through SD cards, tablets or other
            storage/transmitting device are between Edneed Technology Private
            Limited <strong>(“Company/We/Us/Our”)</strong> and its users
            <strong>(“User/You/Your”)</strong>. These Terms constitute an
            electronic record in accordance with the provisions of the
          ...
          <p className="text-xxs">
            ...
            <strong>(“Privacy Policy”)</strong> with respect to registration
            with us, the use of the Application, Website, Services and products
            ...
            other policies with respect to the Application or Website or
            Services or products, the provisions of the Terms shall prevail.
          </p>
          <p className="text-xxs">
            Your use/access/browsing of the SaaS Application or Website or the
            Services or products or registration (with or without payment/with
            or without subscription) through any means shall signify Your
            acceptance of the Terms and Your agreement to be legally bound by
            the same.
          </p>
          <p className="text-xxs">
            If you do not agree with the Terms or the Privacy Policy, please do
            not use the Application or Website or avail the Services or
            ...
            <ol>
              <li>
                <p className="text-xxs">
                  ...
                  third party. Further, you recognize and acknoweldge that the
              ...
              <li>
                ...
                <ol className="text-xxs nest-1">
                  ...
                  <li>
                    ...
                    commercial purposes of any kind, or (c) use the Application
                    and / or Website/our products and Services in any way that
                    is unlawful, or harms the Company or any other person or
                  ...
                  <li>
                    ...
                    <ol className="text-xxs nest-2">
                      <li>
                        ...
                        child-pornographic, lewd, lascivious, profane, invasive
                      ...
                      <li>
                        ...
                        property rights or other proprietary rights of anyone
                        else;
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        enjoying access to the SaaS Application/Website/
                        Services/products, or other affiliated sites, or engage
                        in disruptive attacks such as denial of service attack
                        on the SaaS Application/Website/Services/products;
                      </li>
                      <li>
                        ...
                        the Application, or any content, to obtain or attempt to
                        obtain any content, documents or information through any
                        means not specifically made available through the
              ...
              <li>
                <p className="text-xxs">
                  In the preparation of the SaaS
              ...
              <li>
                <p className="text-xxs">
                  The contents of the SAAS Application/Services/products are
                  ...
                  admission to any educational institutions or passing of any
                  exams or achievement of any specified percentage of marks in
                  any examinations.
                </p>
              </li>
              <li>
                <p className="text-xxs">
                  Certain contents in the SaaS
                  Application/Services/Website/products (in particular relating
                  to assistance in preparations for administrative services) may
              ...
              <li>
                <p className="text-xxs">
                  ...
                  by You to enable effective provision of Services.{" "}
                </p>
              </li>
              <li>
                <p className="text-xxs">
                  ...
                  any deviant behaviour of any such personnel. Any feedback from
              ...
              <li>
                <p className="text-xxs">
                  ...
                  based on its policies. Hence, subscription to the SAAS
              ...
              <li>
                <p className="text-xxs">
                  Any violation by You of the terms may result in immediate
                  suspension or termination or cancellation of Your Accounts
                  apart from any legal remedy that the Company can avail. In
                  such instances, the Company shall not refund or return any
                  amount paid by you and may also disclose Your Account
              ...
              <li>
                <p className="text-xxs">
                  In the event of termination or cancellation of contract by You
                  for any of the reasons and you don’t wish to continue, the
                  Company shall refund or return the amount paid by you as per
                  the Refund policy(within Fifteen days from the date of
                  availing services/products) of the Company from time to time.
                  It shall be fully refunded by the Company within 6-7 days from
                  the date of termination or cancellation of services/products.
                  Refund Policy shall be kept and updated from time to time at
              ...
              <li>
                <p className="text-xxs">
                  ...
                  SaaS Application/products, You shall be required to register
                  yourself with the Application/Services/products, and maintain
                  an account with the Saas Application/Services/products. You
                  will be required to furnish certain information and details,
                  including Your name, mobile number, e-mail address,
                  residential address, grade/class of the student, school name,
                  payment information (credit/debit card details) if required,
                  and any other information deemed necessary by the Application.
                ...
                <ol className="text-xxs nest-1">
                  ...
                  <li>
                    ...
                    password or we may suspend Your account without any
                    liability to the Company, for such period of time as we deem
                    appropriate in the circumstances. We shall not be liable for
                  ...
                  <li>
                    ...
                    times. In addition to the disclaimers set forth in the
                    Terms, the Company shall not be liable to You for any
                    damages arising from Your inability to log into Your account
                    and access the services of the Application at any time.
                  </li>
                </ol>
              </li>
              <li>
                <p className="text-xxs">
                  ...
                  complete and that student using the Application has obtained
                  the consent of parent/legal guardian (in case of minors). The
                  Company reserves the right to terminate Your subscription and
                  / or refuse to provide You with access to the products or
                  Services if it is discovered that You are under the age of 18
                  (eighteen) years and the consent to use the products or
                  Services is not made by Your parent/legal guardian or any
                  information provided by You is inaccurate. You acknowledge
                  that the Company does not have the responsibility to ensure
                  that You conform to the aforesaid eligibility criteria. It
                  shall be Your sole responsibility to ensure that You meet the
                  required qualification. Any persons under the age of 18
                  (eighteen) should seek the consent of their parents/legal
                  guardians before providing any Information about themselves or
                  their parents and other family members on the Application.
                </p>
              </li>
              <li>
                <p className="text-xxs">
              ...
              <li>
                <p className="text-xxs">
                  ...
                  Delhi NCR and You hereby accede to and accept the jurisdiction
                  of such courts.
                </p>
              </li>
              <li>
              ...
              <li>
                <p className="text-xxs">
                  Edneed states website creation within 2 minutes, but the same is limited to the part of services provided by Edneed, and any delay on part of other service providers, or any mandatory technical time limit is not taken into consideration in the proposed time limit. Within two minutes, the user is eligible to get the domain name, login credentials. and interface ready to access the website pertaining to the basic information required and also subject to technical hindrances or any other unusual issues if faced. The complete designing process may take up to 24-48 hrs, subject to the availability of any related resources from the user, any technical hindrances, and the implementation time of the Secure Sockets Layer (SSL).
                </p>
              </li>
              <li>
                <p className="text-xxs">
                  DISCLAIMER: THIS WEBSITE, THE SAAS APPLICATION AND THE
                  SERVICES ARE PROVIDED ON AN "AS IS" BASIS WITH ALL FAULTS AND
                  WITHOUT ANY WARRANTY OF ANY KIND. THE COMPANY HEREBY DISCLAIMS
                  ALL WARRANTIES AND CONDITIONS WITH REGARD TO THE WEBSITE,
              ...
              <li>
                <h3 className="text-xxs base w-500">General Provisions:</h3>

                <ol className="text-xxs nest-1">
                  <li>
                    Notice: All notices served by the Company shall be provided
                    via email to Your account or as a general notification on
                    the Application. Any notice to be provided to the Company
                    should be sent to{" "}
                    <em
                      className="text-xxs primary linkbtn"
                      onClick={(e) => {
                        e.preventDefault();
                  ...
                  <li>
                    ...
                    the Company and You with respect to Your access to or use of
                  ...
                  <li>
                    ...
                    the terms that apply to your use of the Website/Application
                    and Services. You acknowledge that, the Company has given
                    You a reasonable opportunity to review these Terms and that
                    You have agreed to them.
                  </li>
                </ol>
              </li>
              <li>
                <h3 className="text-xxs base w-500">Feedback:</h3>
                <ol className="text-xxs nest-1">
                  <li>
                    Any feedback You provide with respect to the Application
                    shall be deemed to be nonconfidential. The Application shall
                    be free to use such information on an unrestricted basis.
                    Further, by submitting the feedback, You represent and
                    warrant that (i) Your feedback does not contain confidential
                    or proprietary information of You or of third parties; (ii)
                    the Company is not under any obligation of confidentiality,
                    express or implied, with respect to the feedback; (iii) the
                    Application may have something similar to the feedback
                    already under consideration or in development; and (iv) You
                    are not entitled to any compensation or reimbursement of any
                    kind from the Company for the feedback under any
              ...
              <li>
                <h3 className="text-xxs base w-500">Customer Care:</h3>
                <ol className="text-xxs nest-1">
                  <li>
                    ...
                    <em
                      className="text-xxs primary w-600 linkbtn"
                      onClick={(e) => {
                        e.preventDefault();
                        window.open("mailto:", "support@edneed.com");
                      }}
