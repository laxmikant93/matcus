  ...
  return (
    <>
      <div className="edContainer">
        <div className="cookie-policy-custom mt-80">
          <h1 className="sub-heading text-sm w-600">Cookie Policy</h1>
            ...
            <ul>
              ...
              <li>
                ...
                <ul className="cookieSublist">
                  <li>
                    <h5 className="text-xs w-500 mb-3">Account related cookies</h5>
                    <p className="text-xxs w-500">
                  ...
                  <li>
                    <h5 className="text-xs w-500 mb-3">Login related cookies</h5>
                    <p className="text-xxs w-500">
                  ...
                  <li>
                    <h5 className="text-xs w-500 mb-3">
                  ...
                  <li>
                    ...
                    <p className="text-xxs w-500">
                      This site offers membership or payment facilities and some
                  ...
                  <li>
                    <h5 className="text-xs w-500 mb-3">Surveys related cookies</h5>
                    <p className="text-xxs w-500">
                  ...
                  <li>
                    <h5 className="text-xs w-500 mb-3">Forms related cookies</h5>
                    <p className="text-xxs w-500">
                  ...
                  <li>
                    <h5 className="text-xs w-500 mb-3">Site preferences cookies</h5>
                    <p className="text-xxs w-500">
                ...
                <ul className="cookieSublist">
                  ...
                  <li>
                    <p className="text-xxs w-500">
                      ...
                      you have integrated with your site?:12, will set cookies
