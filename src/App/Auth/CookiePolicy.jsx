      ...
      <>
        <div className="row">
          <div className="col-sm-12 mt-40">
            <div className="cookie-policy-custom">
              <div className="logoCustom">
                <img className="brandLogo large" src={logo} alt="" />
              </div>
              <h1 className="sub-heading text-sm mt-20">Cookie Policy</h1>
              <p className="text-xsw-400">
                This is the Cookie Policy for Edneed, accessible from{" "}
                <AppLink to="">https://www.edneed.com</AppLink>
              </p>
              <div className="CookieCounter">
                <ul>
                  <li>
                    <h3 className="text-xs primary ">What Are Cookies</h3>
                  ...
                  <li>
                    <h3 className="text-xs primary ">How We Use Cookies</h3>
                    <p className="text-xxs">
                      ...
                      the functionality and features they add to this site. It
                      is recommended that you leave on all cookies if you are
                      not sure whether you need them or not in case they are
                      used to provide a service that you use.
                    </p>
                  </li>
                  <li>
                    <h3 className="text-xs primary ">Disabling Cookies</h3>
                    <p className="text-xxs">
                  ...
                  <li>
                    <h3 className="text-xs primary ">The Cookies We Set</h3>
                    <ul className="cookieSublist">
                      <li>
                        <h5 className="text-xs w-400">
                      ...
                      <li>
                        ...
                        <p className="text-xxs">
                          ...
                          remember this fact. This prevents you from having to
                          log in every single time you visit a new page. These
                          cookies are typically removed or cleared when you log
                          out to ensure that you can only access restricted
                      ...
                      <li>
                        ...
                        <p className="text-xxs">
                          This site offers membership or payment facilities and
                          some cookies are essential to ensure that your order
                          is remembered between pages so that we can process it
                          properly.
                        </p>
                      </li>
                      <li>
                        ...
                        <p className="text-xxs">
                          ...
                          provide you with accurate results after you change
                          pages.
                        </p>
                      </li>
                      <li>
                  ...
                  <li>
                    <h3 className="text-xs primary ">Third Party Cookies</h3>
                    <p className="text-xxs">
                    ...
                    <ul className="cookieSublist">
                      ...
                      <li>
                        <p className="text-xxs">
                          ...
                          engaging content. These cookies may track things such
                          as how long you spend on the site or pages you visit
                      ...
                      <li>
                        <p className="text-xxs">
                          ...
                          used to ensure that you receive a consistent
                          experience whilst on the site whilst ensuring we
                          understand which optimisations our users appreciate
                          the most.
                        </p>
                      </li>
                      <li>
                        <p className="text-xxs">
                          ...
                          is the kind of data that these cookies will track.
                          This is important to you as it means that we can
                          accurately make business predictions that allow us to
                          monitor our advertising and product costs to ensure
                      ...
                      <li>
                        <p className="text-xxs">
                          ...
                          across the web and limit the number of times that a
                      ...
                      <li>
                        <p className="text-xxs">
                          We use adverts to offset the costs of running this
                          site and provide funding for further development. The
                          behavioural advertising cookies used by this site are
                          designed to ensure that we provide you with the most
                          relevant adverts where possible by anonymously
                          tracking your interests and presenting similar things
                      ...
                      <li>
                        <p className="text-xxs">
                          ...
                          tracking cookies simply allow us to see if our
                          customers have come to the site through one of our
                          partner sites so that we can credit them appropriately
                          and where applicable allow our affiliate partners to
                          provide any bonus that they may provide you for making
                          a purchase.
                        </p>
                      </li>
                      <li>
                        <p className="text-xxs">
                          ...
                          network in various ways. For these to work the
                          following social media sites including; List the
                          social networks whose features you have integrated
                          with your site?:12, will set cookies through our site
                          which may be used to enhance your profile on their
                          site or contribute to the data they hold for various
                          purposes outlined in their respective privacy
                          policies.
                        </p>
                      </li>
                    </ul>
                  ...
                  <li>
                    <h3 className="text-xs primary ">More Information</h3>
                    <p className="text-xxs">
