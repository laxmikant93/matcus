...
import InstituteMenus from "./sidebarmenuEmployee.json";
                        ...
                        <li className={`subMenuListItem`}  >
                          {
                            subMenuItem1.subMenuItem && subMenuItem1.subMenuItem.length >= 1
                              ...
                              subMenuItem1.menuName === "My Templates" && user.user_institute_isOld ? (
                                "") :
                                subMenuItem1.menuName === "Edit Website" && !user.user_institute_isOld ? (<AppLink to={subMenuItem1.menuLink} className={pathname === subMenuItem1.menuLink ? "active" : ""}>
                                  <span className="title">{subMenuItem1.menuName}</span>
                                </AppLink>) : (
                                  <>
                                    {
                                      subMenuItem1.menuName === "Edit Website" && user.user_institute_isOld ? (
                                        ""
                                      ) : (
